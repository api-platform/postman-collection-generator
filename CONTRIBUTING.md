# Contributing to PostmanGeneratorBundle

First of all, thank you for contributing, you're awesome!

To have your code integrated in the PostmanGeneratorBundle project, there is some rules to follow, but don't panic,
it's easy!
...
* Also don't forget to add a comment when you update a PR with a ping to the maintainer (`@dunglas` or `@vincentchalamon`),
so we will get a notification
* [Squash your commits](#squash-your-commits) into one commit

All Pull Requests must include [this header](https://github.com/dunglas/DunglasApiBundle/blob/master/.github/PULL_REQUEST_TEMPLATE.md).
